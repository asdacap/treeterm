...
export interface LoadReviewsRequest {
  worktreePath: string;
}

export interface LoadReviewsResponse {
  success: boolean;
...
export interface UpdateOutdatedReviewsRequest {
  worktreePath: string;
  currentCommitHash: string;
}

export interface UpdateOutdatedReviewsResponse {
  success: boolean;
  reviews?: ReviewsData | undefined;
  error?: string | undefined;
}
...
export const ReviewComment: MessageFns<ReviewComment> = {
  encode(message: ReviewComment, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.filePath !== "") {
    ...
    if (message.commitHash !== "") {
      writer.uint32(42).string(message.commitHash);
    }
    if (message.createdAt !== 0) {
      writer.uint32(48).int64(message.createdAt);
    }
    if (message.isOutdated !== false) {
      writer.uint32(56).bool(message.isOutdated);
    }
    if (message.side !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReviewComment {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.isOutdated = reader.bool();
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): ReviewComment {
    return {
      ...
      createdAt: isSet(object.createdAt)
        ...
        ? globalThis.Number(object.created_at)
        : 0,
      isOutdated: isSet(object.isOutdated)
        ? globalThis.Boolean(object.isOutdated)
        : isSet(object.is_outdated)
        ? globalThis.Boolean(object.is_outdated)
        : false,
  ...
  toJSON(message: ReviewComment): unknown {
    ...
    if (message.isOutdated !== false) {
      obj.isOutdated = message.isOutdated;
    }
    if (message.side !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<ReviewComment>, I>>(object: I): ReviewComment {
    ...
    message.createdAt = object.createdAt ?? 0;
    message.isOutdated = object.isOutdated ?? false;
...
export const ReviewsData: MessageFns<ReviewsData> = {
  encode(message: ReviewsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.comments) {
      ReviewComment.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.comments.push(ReviewComment.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ReviewsData {
    return {
      ...
      comments: globalThis.Array.isArray(object?.comments)
        ? object.comments.map((e: any) => ReviewComment.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: ReviewsData): unknown {
    ...
    if (message.comments?.length) {
      obj.comments = message.comments.map((e) => ReviewComment.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ReviewsData>, I>>(object: I): ReviewsData {
    ...
    message.comments = object.comments?.map((e) => ReviewComment.fromPartial(e)) || [];
    return message;
  },
};

function createBaseLoadReviewsRequest(): LoadReviewsRequest {
  return { worktreePath: "" };
}

export const LoadReviewsRequest: MessageFns<LoadReviewsRequest> = {
  encode(message: LoadReviewsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worktreePath !== "") {
      writer.uint32(10).string(message.worktreePath);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LoadReviewsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLoadReviewsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LoadReviewsRequest {
    return {
      worktreePath: isSet(object.worktreePath)
        ? globalThis.String(object.worktreePath)
        : isSet(object.worktree_path)
  ...
  toJSON(message: LoadReviewsRequest): unknown {
    const obj: any = {};
    if (message.worktreePath !== "") {
      obj.worktreePath = message.worktreePath;
    }
  ...
  create<I extends Exact<DeepPartial<LoadReviewsRequest>, I>>(base?: I): LoadReviewsRequest {
    return LoadReviewsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LoadReviewsRequest>, I>>(object: I): LoadReviewsRequest {
    const message = createBaseLoadReviewsRequest();
    message.worktreePath = object.worktreePath ?? "";
    return message;
  },
...
function createBaseLoadReviewsResponse(): LoadReviewsResponse {
  return { success: false, reviews: undefined, error: undefined };
}

export const LoadReviewsResponse: MessageFns<LoadReviewsResponse> = {
  encode(message: LoadReviewsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.reviews !== undefined) {
      ReviewsData.encode(message.reviews, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LoadReviewsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLoadReviewsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LoadReviewsResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
  ...
  toJSON(message: LoadReviewsResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<LoadReviewsResponse>, I>>(base?: I): LoadReviewsResponse {
    return LoadReviewsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LoadReviewsResponse>, I>>(object: I): LoadReviewsResponse {
    const message = createBaseLoadReviewsResponse();
    message.success = object.success ?? false;
...
function createBaseSaveReviewsRequest(): SaveReviewsRequest {
  return { worktreePath: "", reviews: undefined };
}

export const SaveReviewsRequest: MessageFns<SaveReviewsRequest> = {
  encode(message: SaveReviewsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worktreePath !== "") {
      writer.uint32(10).string(message.worktreePath);
    }
    if (message.reviews !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SaveReviewsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSaveReviewsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): SaveReviewsRequest {
    return {
      worktreePath: isSet(object.worktreePath)
        ? globalThis.String(object.worktreePath)
        : isSet(object.worktree_path)
  ...
  toJSON(message: SaveReviewsRequest): unknown {
    const obj: any = {};
    if (message.worktreePath !== "") {
      obj.worktreePath = message.worktreePath;
    }
  ...
  create<I extends Exact<DeepPartial<SaveReviewsRequest>, I>>(base?: I): SaveReviewsRequest {
    return SaveReviewsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SaveReviewsRequest>, I>>(object: I): SaveReviewsRequest {
    const message = createBaseSaveReviewsRequest();
    message.worktreePath = object.worktreePath ?? "";
    message.reviews = (object.reviews !== undefined && object.reviews !== null)
      ? ReviewsData.fromPartial(object.reviews)
...
function createBaseSaveReviewsResponse(): SaveReviewsResponse {
  return { success: false, error: undefined };
}

export const SaveReviewsResponse: MessageFns<SaveReviewsResponse> = {
  encode(message: SaveReviewsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SaveReviewsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSaveReviewsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): SaveReviewsResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  ...
  toJSON(message: SaveReviewsResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<SaveReviewsResponse>, I>>(base?: I): SaveReviewsResponse {
    return SaveReviewsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SaveReviewsResponse>, I>>(object: I): SaveReviewsResponse {
    const message = createBaseSaveReviewsResponse();
    message.success = object.success ?? false;
    message.error = object.error ?? undefined;
    return message;
...
function createBaseAddReviewCommentRequest(): AddReviewCommentRequest {
  return { worktreePath: "", filePath: "", lineNumber: 0, text: "", commitHash: "", isOutdated: false, side: "" };
}

export const AddReviewCommentRequest: MessageFns<AddReviewCommentRequest> = {
  encode(message: AddReviewCommentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worktreePath !== "") {
      writer.uint32(10).string(message.worktreePath);
    }
    if (message.filePath !== "") {
    ...
    if (message.isOutdated !== false) {
      writer.uint32(48).bool(message.isOutdated);
    }
    if (message.side !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddReviewCommentRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAddReviewCommentRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AddReviewCommentRequest {
    return {
      worktreePath: isSet(object.worktreePath)
        ? globalThis.String(object.worktreePath)
        : isSet(object.worktree_path)
  ...
  toJSON(message: AddReviewCommentRequest): unknown {
    const obj: any = {};
    if (message.worktreePath !== "") {
      obj.worktreePath = message.worktreePath;
    }
  ...
  create<I extends Exact<DeepPartial<AddReviewCommentRequest>, I>>(base?: I): AddReviewCommentRequest {
    return AddReviewCommentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddReviewCommentRequest>, I>>(object: I): AddReviewCommentRequest {
    const message = createBaseAddReviewCommentRequest();
    message.worktreePath = object.worktreePath ?? "";
    message.filePath = object.filePath ?? "";
    message.lineNumber = object.lineNumber ?? 0;
...
function createBaseAddReviewCommentResponse(): AddReviewCommentResponse {
  return { success: false, comment: undefined, error: undefined };
}

export const AddReviewCommentResponse: MessageFns<AddReviewCommentResponse> = {
  encode(message: AddReviewCommentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.comment !== undefined) {
      ReviewComment.encode(message.comment, writer.uint32(18).fork()).join();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddReviewCommentResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAddReviewCommentResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.comment = ReviewComment.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): AddReviewCommentResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      comment: isSet(object.comment) ? ReviewComment.fromJSON(object.comment) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  },

  toJSON(message: AddReviewCommentResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
    if (message.comment !== undefined) {
      obj.comment = ReviewComment.toJSON(message.comment);
    }
    if (message.error !== undefined) {
      obj.error = message.error;
    }
  ...
  create<I extends Exact<DeepPartial<AddReviewCommentResponse>, I>>(base?: I): AddReviewCommentResponse {
    return AddReviewCommentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AddReviewCommentResponse>, I>>(object: I): AddReviewCommentResponse {
    const message = createBaseAddReviewCommentResponse();
    message.success = object.success ?? false;
    message.comment = (object.comment !== undefined && object.comment !== null)
      ? ReviewComment.fromPartial(object.comment)
      : undefined;
    message.error = object.error ?? undefined;
    return message;
  },
...
function createBaseDeleteReviewCommentRequest(): DeleteReviewCommentRequest {
  return { worktreePath: "", commentId: "" };
}

export const DeleteReviewCommentRequest: MessageFns<DeleteReviewCommentRequest> = {
  encode(message: DeleteReviewCommentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worktreePath !== "") {
      writer.uint32(10).string(message.worktreePath);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteReviewCommentRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteReviewCommentRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DeleteReviewCommentRequest {
    return {
      worktreePath: isSet(object.worktreePath)
        ? globalThis.String(object.worktreePath)
        : isSet(object.worktree_path)
  ...
  toJSON(message: DeleteReviewCommentRequest): unknown {
    const obj: any = {};
    if (message.worktreePath !== "") {
      obj.worktreePath = message.worktreePath;
    }
  ...
  create<I extends Exact<DeepPartial<DeleteReviewCommentRequest>, I>>(base?: I): DeleteReviewCommentRequest {
    return DeleteReviewCommentRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteReviewCommentRequest>, I>>(object: I): DeleteReviewCommentRequest {
    const message = createBaseDeleteReviewCommentRequest();
    message.worktreePath = object.worktreePath ?? "";
...
function createBaseDeleteReviewCommentResponse(): DeleteReviewCommentResponse {
  return { success: false, error: undefined };
}

export const DeleteReviewCommentResponse: MessageFns<DeleteReviewCommentResponse> = {
  encode(message: DeleteReviewCommentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteReviewCommentResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteReviewCommentResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DeleteReviewCommentResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  ...
  toJSON(message: DeleteReviewCommentResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<DeleteReviewCommentResponse>, I>>(base?: I): DeleteReviewCommentResponse {
    return DeleteReviewCommentResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteReviewCommentResponse>, I>>(object: I): DeleteReviewCommentResponse {
    const message = createBaseDeleteReviewCommentResponse();
    message.success = object.success ?? false;
    message.error = object.error ?? undefined;
    return message;
...
function createBaseUpdateOutdatedReviewsRequest(): UpdateOutdatedReviewsRequest {
  return { worktreePath: "", currentCommitHash: "" };
}

export const UpdateOutdatedReviewsRequest: MessageFns<UpdateOutdatedReviewsRequest> = {
  encode(message: UpdateOutdatedReviewsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worktreePath !== "") {
      writer.uint32(10).string(message.worktreePath);
    }
    if (message.currentCommitHash !== "") {
      writer.uint32(18).string(message.currentCommitHash);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOutdatedReviewsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateOutdatedReviewsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.currentCommitHash = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): UpdateOutdatedReviewsRequest {
    return {
      worktreePath: isSet(object.worktreePath)
        ? globalThis.String(object.worktreePath)
        : isSet(object.worktree_path)
        ? globalThis.String(object.worktree_path)
        : "",
      currentCommitHash: isSet(object.currentCommitHash)
        ? globalThis.String(object.currentCommitHash)
        : isSet(object.current_commit_hash)
        ? globalThis.String(object.current_commit_hash)
        : "",
    };
  },

  toJSON(message: UpdateOutdatedReviewsRequest): unknown {
    const obj: any = {};
    if (message.worktreePath !== "") {
      obj.worktreePath = message.worktreePath;
    }
    if (message.currentCommitHash !== "") {
      obj.currentCommitHash = message.currentCommitHash;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<UpdateOutdatedReviewsRequest>, I>>(base?: I): UpdateOutdatedReviewsRequest {
    return UpdateOutdatedReviewsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateOutdatedReviewsRequest>, I>>(object: I): UpdateOutdatedReviewsRequest {
    const message = createBaseUpdateOutdatedReviewsRequest();
    message.worktreePath = object.worktreePath ?? "";
    message.currentCommitHash = object.currentCommitHash ?? "";
    return message;
  },
};

function createBaseUpdateOutdatedReviewsResponse(): UpdateOutdatedReviewsResponse {
  return { success: false, reviews: undefined, error: undefined };
}

export const UpdateOutdatedReviewsResponse: MessageFns<UpdateOutdatedReviewsResponse> = {
  encode(message: UpdateOutdatedReviewsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.reviews !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOutdatedReviewsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateOutdatedReviewsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): UpdateOutdatedReviewsResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      reviews: isSet(object.reviews) ? ReviewsData.fromJSON(object.reviews) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
  ...
  toJSON(message: UpdateOutdatedReviewsResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<UpdateOutdatedReviewsResponse>, I>>(base?: I): UpdateOutdatedReviewsResponse {
    return UpdateOutdatedReviewsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateOutdatedReviewsResponse>, I>>(
    object: I,
  ): UpdateOutdatedReviewsResponse {
    const message = createBaseUpdateOutdatedReviewsResponse();
    message.success = object.success ?? false;
    message.reviews = (object.reviews !== undefined && object.reviews !== null)
      ? ReviewsData.fromPartial(object.reviews)
...
export const TreeTermDaemonService = {
  ...
  /** Reviews Operations */
  loadReviews: {
    path: "/treeterm.TreeTermDaemon/LoadReviews" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: LoadReviewsRequest): Buffer => Buffer.from(LoadReviewsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): LoadReviewsRequest => LoadReviewsRequest.decode(value),
    responseSerialize: (value: LoadReviewsResponse): Buffer => Buffer.from(LoadReviewsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): LoadReviewsResponse => LoadReviewsResponse.decode(value),
  },
  saveReviews: {
    path: "/treeterm.TreeTermDaemon/SaveReviews" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: SaveReviewsRequest): Buffer => Buffer.from(SaveReviewsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SaveReviewsRequest => SaveReviewsRequest.decode(value),
    responseSerialize: (value: SaveReviewsResponse): Buffer => Buffer.from(SaveReviewsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): SaveReviewsResponse => SaveReviewsResponse.decode(value),
  },
  addReviewComment: {
    path: "/treeterm.TreeTermDaemon/AddReviewComment" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: AddReviewCommentRequest): Buffer =>
      Buffer.from(AddReviewCommentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AddReviewCommentRequest => AddReviewCommentRequest.decode(value),
    responseSerialize: (value: AddReviewCommentResponse): Buffer =>
      Buffer.from(AddReviewCommentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AddReviewCommentResponse => AddReviewCommentResponse.decode(value),
  },
  deleteReviewComment: {
    path: "/treeterm.TreeTermDaemon/DeleteReviewComment" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: DeleteReviewCommentRequest): Buffer =>
      Buffer.from(DeleteReviewCommentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteReviewCommentRequest => DeleteReviewCommentRequest.decode(value),
    responseSerialize: (value: DeleteReviewCommentResponse): Buffer =>
      Buffer.from(DeleteReviewCommentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DeleteReviewCommentResponse => DeleteReviewCommentResponse.decode(value),
  },
  updateOutdatedReviews: {
    path: "/treeterm.TreeTermDaemon/UpdateOutdatedReviews" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: UpdateOutdatedReviewsRequest): Buffer =>
      Buffer.from(UpdateOutdatedReviewsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateOutdatedReviewsRequest => UpdateOutdatedReviewsRequest.decode(value),
    responseSerialize: (value: UpdateOutdatedReviewsResponse): Buffer =>
      Buffer.from(UpdateOutdatedReviewsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): UpdateOutdatedReviewsResponse => UpdateOutdatedReviewsResponse.decode(value),
  },
...
export interface TreeTermDaemonServer extends UntypedServiceImplementation {
  ...
  addReviewComment: handleUnaryCall<AddReviewCommentRequest, AddReviewCommentResponse>;
  deleteReviewComment: handleUnaryCall<DeleteReviewCommentRequest, DeleteReviewCommentResponse>;
...
export interface TreeTermDaemonClient extends Client {
  ...
  /** Reviews Operations */
  loadReviews(
    request: LoadReviewsRequest,
    callback: (error: ServiceError | null, response: LoadReviewsResponse) => void,
  ): ClientUnaryCall;
  loadReviews(
    request: LoadReviewsRequest,
    metadata: Metadata,
  ...
  saveReviews(
    ...
    callback: (error: ServiceError | null, response: SaveReviewsResponse) => void,
  ): ClientUnaryCall;
  saveReviews(
    request: SaveReviewsRequest,
    metadata: Metadata,
  ...
  addReviewComment(
    ...
    callback: (error: ServiceError | null, response: AddReviewCommentResponse) => void,
  ): ClientUnaryCall;
  addReviewComment(
    request: AddReviewCommentRequest,
    metadata: Metadata,
  ...
  deleteReviewComment(
    ...
    callback: (error: ServiceError | null, response: DeleteReviewCommentResponse) => void,
  ): ClientUnaryCall;
  deleteReviewComment(
    request: DeleteReviewCommentRequest,
    metadata: Metadata,
  ...
  updateOutdatedReviews(
    request: UpdateOutdatedReviewsRequest,
    callback: (error: ServiceError | null, response: UpdateOutdatedReviewsResponse) => void,
  ): ClientUnaryCall;
  updateOutdatedReviews(
    request: UpdateOutdatedReviewsRequest,
    metadata: Metadata,
