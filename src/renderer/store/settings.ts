...
const defaultSettings: Settings = {
  ...
  terminalAnalyzer: {
    ...
    titleSystemPrompt: 'Given the terminal output below, suggest a short title (max 5 words) for this workspace session. Respond with ONLY the title text, nothing else.',
