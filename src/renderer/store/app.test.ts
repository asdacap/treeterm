...
vi.mock('../../applications/terminal/renderer', () => ({
  createTerminalApplication: vi.fn().mockReturnValue({
    ...
    render: () => null, onWorkspaceLoad: () => {}, canClose: true, canHaveMultiple: true, showInNewTabMenu: true,
...
vi.mock('../../applications/filesystem/renderer', () => ({
  filesystemApplication: {
    ...
    render: () => null, onWorkspaceLoad: () => {}, canClose: true, canHaveMultiple: false, showInNewTabMenu: true,
    displayStyle: 'flex', isDefault: false
  }
}))
...
vi.mock('../../applications/review/renderer', () => ({
  reviewApplication: {
    ...
    render: () => null, onWorkspaceLoad: () => {}, canClose: true, canHaveMultiple: false, showInNewTabMenu: false,
    displayStyle: 'flex', isDefault: false
  }
}))
