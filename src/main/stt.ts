...
export function registerSTTHandlers(server: IpcServer): void {
  // OpenAI Whisper transcription
  server.onSttTranscribeOpenai(async (audioBuffer, apiKey, language) => {
    try {
  ...
  server.onSttCheckMicPermission(async () => {
