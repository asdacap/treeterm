...
const mockWorkspaceStore = createStore<WorkspaceStoreState>()(() => ({
  ...
  initTab: vi.fn(), getTabRef: vi.fn().mockReturnValue(null), getCachedTerminal: vi.fn().mockReturnValue(null), setCachedTerminal: vi.fn(), disposeCachedTerminal: vi.fn(), disposeAllCachedTerminals: vi.fn(),
